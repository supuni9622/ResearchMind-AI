...
**Last Updated:** 2026-07-19 (+ Chat history and reliability follow-up: server-backed conversation replay, deterministic message order, completion-event persistence fix, and first-question Groq titles with full-title tooltips)
