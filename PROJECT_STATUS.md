...
Evaluation Platform Expansion — NDCG ✅, Groundedness ✅, Faithfulness ✅, Citation Accuracy ✅, Hallucination Rate ✅ (derived metric), Regression Detection ✅ — E2E Evaluation ⏳, Security Evaluation ⏳, LangSmith dataset sync ⏳ (all built into `benchmarks/`, not a new `app/ai/evaluation/` — see Engineering Benchmark Platform section above)
