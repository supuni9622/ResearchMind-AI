...
class ProcessedDocument(BaseModel):
    ...
    raw_text: str = Field(description="Plain text representation of the document.")

    markdown: str = Field(description="Structured Markdown representation generated by the parser.")

    blocks: list[DocumentBlockType] = Field(
        default_factory=list, description="Ordered semantic document blocks."
    )
