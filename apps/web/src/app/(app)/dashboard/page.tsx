...
import { SearchIcon, UploadIcon, MessageIcon } from '@/components/ui/icons';
    ...
    <div className="px-8 py-10 max-w-6xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-8">
        ...
        >
          ...
          <h2 className="text-stone-100 text-sm font-medium mb-1">Brainstorm in Chat</h2>
          <p className="text-stone-500 text-[13px]">
            Free-space ideas, web search, and paper discovery
          </p>
        </Link>
        ...
        >
          ...
          <p className="text-stone-500 text-[13px]">
            Cited answers or full reports, grounded in your library
          </p>
        </Link>
        ...
        >
          ...
          <p className="text-stone-500 text-[13px]">Add papers you found to ground Research on</p>
        </Link>
      </div>
