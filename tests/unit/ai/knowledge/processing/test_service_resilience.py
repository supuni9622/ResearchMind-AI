...
def _default_chunk_artifact() -> ChunkArtifact:
...
def _default_chunk_artifact_builder() -> MagicMock:
    """Fake chunk artifact builder: returns a minimal real ChunkArtifact
    (see _default_chunk_artifact)."""
    builder = MagicMock()
    builder.build = MagicMock(return_value=_default_chunk_artifact())
    return builder
